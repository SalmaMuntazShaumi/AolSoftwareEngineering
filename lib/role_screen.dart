          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: 30),
                Text(
                  'Pilih peran Anda untuk menjadi bagian dari solusi berkelanjutan!',
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => LoginPage(role: "pembeli"),
                        ),
                      );
                    },
                    child: Text('Pembeli'),
                    style: ButtonStyle(
                      backgroundColor:
                      MaterialStateProperty.all(Color(0xff7BC9FF)),
                      foregroundColor:
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => LoginPage(role: "penjual"),
                        ),
                      );
                    },
